...
def reconstruct_backup(backup_dir):
    max_proc = -1
    ...
    with h5py.File(os.path.join(backup_dir, '0_0.hd5'), 'r') as h5_f:
    ...
    with h5py.File(os.path.join(out_dir, 'recon.hd5'), 'w') as h5_f_out:
...
if __name__ == '__main__':
    args = parse_args()
    reconstruct_backup(args.backup_dir)
